...
import com.wool.board.dto.BoardSerachDTO;
...
public class BoardController {
	...
	public String boardSearch(Model model , BoardSerachDTO boardSerachDTO) {
		
		model.addAttribute("list", boardService.BoardSearch(boardSerachDTO));
		return "./board/board_select_all_view";
	}
	...
	public String ReplyDelete(BoardDTO boardDTO, @RequestParam(value = "rno") int rno,
